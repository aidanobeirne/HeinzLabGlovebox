...
class GloveBoxSetupWindow(QMainWindow):
    ...
    def eventLoop(self):
        ...
        self.StageLocationPlot.setData(abs(XPos), abs(YPos))
...
##################################################################################################
        ...
        # self.LinearPolarizer = ThorlabsStages.ThorlabsCageRotator(SN_motor = '55164244') Commented out while we wait for new rotation mount 
        ...
        self.SpecPlotWindowGroupBox = Dock('Spectrum')
        self.StageLocationWindowGroupBox = Dock('Stage Location')
...
#        grid_layout.addWidget(self.LaplacianSharpnessSlider, 1, 12, 3, 1)
    ...
    def click_to_move(self, evt):
        if evt.button() == 1 and evt.double() == True:
            ...
            self.StageLocationPlot.setData(mousePoint.x(), mousePoint.y())
