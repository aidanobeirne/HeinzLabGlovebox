    ...
    def eventLoop(self):
        ...
        if self.SpectrometerWidget.SpectrometerWidget != None:        
            if self.SpectrometerWidget.SpectrometerWidget.ContinousMode:
                self.SpecPlot.setData(self.SpectrometerWidget.SpectrometerWidget.LatestContinousSpectrum, pen=(0,0,255))
...
#        grid_layout.addWidget(self.LaplacianSharpnessSlider, 1, 12, 3, 1)
        ...
        #--------------------------------------------------------------------------------------------------------
        self.SpectrometerWidget = AdvancedSpectrometerWidget.CloseableSpectrometerWidget(lambda _ : self.SpecPlot.setData(self.SpectrometerWidget.SpectrometerWidget.takeSpectrum(), pen=(0,0,255)))
